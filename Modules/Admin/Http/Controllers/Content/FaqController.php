...
use Modules\Entity\Model\ContentFaq\ContentFaq as Model;

class FaqController extends Controller {
    use MainCrudMethod;
    protected $view_path = 'admin::page.content.faq';
    protected $route_path = 'admin_faq';
    protected $title_path = 'title.faq';
