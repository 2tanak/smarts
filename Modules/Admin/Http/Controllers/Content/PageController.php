...
use Modules\Entity\Model\ContentPage\ContentPage as Model;

class PageController extends Controller {
    use MainCrudMethod;
    protected $view_path = 'admin::page.content.page';
    protected $route_path = 'admin_c_page';
    protected $title_path = 'title.c_page';
