...
<fieldset class="content-group">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input-show name="sait_priem" id="sait_priem" :model='$model->getRelDataObj()' group='data'   />
        </div>
        <div class="col-md-4">
...
<fieldset class="content-group">
    ...
    <div class="row">
        <div class="col-md-3">
            <input-show name="instagram" id="instagram" :model='$model->getRelSocialObj()' group='social'   />
        </div>
        <div class="col-md-3">
            <input-show name="facebook" id="facebook" :model='$model->getRelSocialObj()' group='social'   />
        </div>
        <div class="col-md-3">
            <input-show name="twitter" id="twitter" :model='$model->getRelSocialObj()' group='social'   />
        </div>
        <div class="col-md-3">
            <input-show name="youtube" id="youtube" :model='$model->getRelSocialObj()' group='social'   />
        </div>
    </div>
</fieldset>
