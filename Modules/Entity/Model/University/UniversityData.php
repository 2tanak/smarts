...
class UniversityData extends ModelParent {
    ...
    protected $fillable = [ 'university_id', 'web_sait', 'address_off', 'address_legal', 'coor', 'phones', 'email', 'owner_type',
                            ...
                            'is_med_insurance', 'is_inter_programm', 'exchange_links', 'sait_priem'];
    function relTrans(){
        return $this->hasOne('Modules\Entity\Model\University\TransUniversity', 'el_id', 'university_id');
    }
    ...
    function getWebSaitCleanAttribute(){
        $v = $this->web_sait;
    ...
    function getSaitPriemCleanAttribute(){
        $v = $this->sait_priem;
