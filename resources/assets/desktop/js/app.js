...
var app_locale = document.documentElement.lang;
...
$('select[name=country_id]').on('change', function () {
    ...
    var t = $(this).find('option:selected').attr('data-code');
    $('.global_input-phone p').text(t);

    $('input[name=country_code]').val(t);
...
//     }else{
//         $('.univerProgramItemHeader').removeClass('active');
//         $(this).addClass('active');
//         $('.univerProgramItemBody').slideUp('show');
//         $(`.id_${id}`).slideDown('show');
//     }
// })
        ...
        $(item).find($('.univerProgramItemHeader')).click(function () {
            if ($(this).parent().parent().hasClass('show')) {
                ...
                $('.univerProgramItem.show').animate({
                    height: $('.univerProgramItem.show .univerProgramItemHeader').innerHeight()
                }, 100);
